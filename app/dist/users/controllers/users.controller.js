...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], UsersController.prototype, "getUserByWalletAddress", null);
__decorate([
    (0, common_1.Post)(),
...
__decorate([
    (0, common_1.Put)(':id/nft/:nftId'),
    openapi.ApiResponse({ status: 200, type: require("../entities/user.entity").User }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Param)('nftId', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "addCategoryByProduct", null);
__decorate([
    (0, common_1.Put)(':id'),
    openapi.ApiResponse({ status: 200, type: require("../entities/user.entity").User }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
...
__decorate([
    (0, common_1.Delete)(':id/nft/:nftId'),
    openapi.ApiResponse({ status: 200, type: require("../entities/user.entity").User }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Param)('nftId', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
